...
- ~~1:30 - lab tour with UAA and Mary
...
- tidied 342
- processed package
- 1:30 photo scout lab tour 
	- ASK SAMA about any photos of bonsai code (IP) + if mary needs to be ppe'd for photos in 365
- bonsai notes
- processed package
# to do tomorrow
THURSDAY 13TH - pizza delivery at 11:45 - kincaid loading dock, beverages in the fridge
- sign in sheet to catherine + beverage leftovers in the room
THURSDAY 13TH - 12 - GO TO PSY GRAD VISIT DAY AND GET SIGN IN SHEET
THURSDAY 13TH AND FRIDAY 14TH - hosting mary in her psych school interviews
